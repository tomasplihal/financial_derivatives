...
- Apple agrees to pay Citigroup a **fixed 3% annual interest rate**, with biannual
payments based on a **notional principal of $100 million**.  

- In return, Citigroup pays Apple interest at the **six-month SOFR rate**, calculated on
the same principal.  
...
The table below illustrates potential cash flow outcomes, maintaining the **$100 million
notional principal**. The net cash flow for Apple varies due to SOFR fluctuations,
sometimes resulting in payments and other times in receipts.
...
The table below illustrates the cash flows for Barclays exchanged over the swap's
duration:  
