...
8. Calculate the value of a three-month at-the-money European call option on a stock
...
9. Calculate the value of an eight-month European put option on a currency with a strike
...
10. What is implied volatility? How can it be calculated?

11. The volatility of a stock price is 30\% per annum. What is the standard deviation of
the percentage price change in one trading day?

12. What is the actual implied volatility of the S\&P 500? Try to interpret the value.

13. A call option on a non-dividend-paying stock has a market price of \$2.50.  The
