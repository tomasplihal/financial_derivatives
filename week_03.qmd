...
interest payments for a predetermined amount of principal at a future date. The
agreement allows one party to pay a fixed interest rate and receive a floating interest
rate, or vice versa. The key characteristics of FRAs make them valuable tools for
financial risk management and speculation.

LIBOR (London Interbank Offered Rate) has been the predominant reference rate for FRAs.
However, with the phase-out of LIBOR, alternative reference rates such as SOFR (Secured
Overnight Financing Rate) and SONIA (Sterling Overnight Index Average) are gaining
prominence.
...
- **Risk Management:** FRAs allow businesses and financial institutions to hedge against
interest rate fluctuations, securing borrowing costs or investment returns in advance.
- **Speculation:** Traders can speculate on the direction of future interest rates,
entering FRAs to profit from their predictions.
- **Customization:** FRAs can be tailored to specific needs, such as the amount,
duration, and the starting date of the agreement, providing flexibility.

### Valuation and Pricing

- **Initial Value:** At inception, the fixed rate of an FRA is set equal to the
prevailing forward rate for the contract period, making the initial value of the
contract zero.
- **Value Over Time:** The value of an FRA changes as market interest rates fluctuate.
If market rates rise above the FRA rate, the buyer (fixed rate payer) benefits, and vice
versa.
- **Settlement:** The difference between the agreed fixed rate and the reference
floating rate at the settlement date is paid by the losing party to the winning party,
adjusted for the contract's term.
...
1. Suppose that you enter into a three-month forward contract on a non-dividend-paying
...
2. A four-months long forward contract on a non-dividend-paying stock is entered into
...
continuous compounding.
    ...
    contract?
3. The risk-free rate of interest is 4.1% per annum with continuous compounding, and the
...
4. A stock index currently stands at 725. The risk-free interest rate is 7.6% per annum
...
5. An index is 550. The three-month risk-free rate is 4.60% per annum and the dividend
...
6. The spot price of silver is \$11 per ounce. The storage costs are \$0.25 per ounce
...
7. The spot price of oil is \$39 per barrel and the cost of storing a barrel of oil for
...
1. Suppose that the risk-free interest rate is 3.00% per annum with continuous
...
2. The eight-month interest rates in Switzerland and the United States are,
...
3. When a known future cash outflow in a foreign currency is hedged by a company using a
...
Explain the nature of this risk. In particular, consider whether the company is better
